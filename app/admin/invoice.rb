ActiveAdmin.register Invoice do
    ...
    tabs do
      tab halfdays_human_name, id: 'halfday_participation' do
        f.inputs do
          ...
          f.input :paid_missing_haldays_works, as: :number, min: 0, max: 99999.95, step: 0.05
  ...
  before_build do |invoice|
    if params[:halfday_participation_id]
      ...
      invoice.object = hp
      invoice.paid_missing_haldays_works = hp.participants_count
    ...
    invoice.paid_missing_haldays_works ||= 1
